...
//    req.bText = NO;
    ...
    if (scene == WXSceneSession) {
        req.message.title = [NSString stringWithFormat:NSLocalizedString(@"weChatShare","WeChat Share Text"), NSLocalizedStringFromTable(@"CFBundleDisplayName", @"InfoPlist", nil)];
